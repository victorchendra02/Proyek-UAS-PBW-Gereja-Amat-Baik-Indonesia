...
<body>
    ...
    <a href="form_insertGallery.html">Insert DB Article</a>
    <a href="formUpload.php">Insert Artikel</a>
    ...
    ?>
        ...
        <h4><u>Data Artikel</u></h4>
        <form action="delete.php" method="post">
        <table border="1">
            <tr>
                <th></th>
                <th width="100">ID</th>
                <th width="100">file_pdf</th>
            </tr>
            <?php
