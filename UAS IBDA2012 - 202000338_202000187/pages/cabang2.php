...
<html lang="en">
    <head>
        ...
        <title>GABI - Jakarta Pusat | Indonesia</title>
    </head>
    <body>
        <!-- header navbar -->
        ...
        <div class="container pt-5 pb-2 text-center">
            <h1><b>GABI | Jakarta Pusat - Indonesia</b></h1>
        </div>
        <div class="container pb-5 d-flex justify-content-center">
            <div class="card mb-3" style="width: 70%">
                <div class="container pt-2">
                    <img src="../img/galeri_2.jpg" class="card-img-top" alt="gambarrr 1" style="border-radius: 5px" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Gereja Amat Baik Indonesia - Jakarta Pusat | Indonesia</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <p class="card-text"><small class="text-muted">Aula John Star</small></p>
                </div>
            </div>
        </div>
        ...
        <div class="container pb-5">
            ...
            $query = "SELECT * FROM jemaat WHERE cabang = 'b' order by tahun";
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="container py-4 d-flex justify-content-center">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1044812.5395533633!2d106.36879516858077!3d-6.381549594135404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta!5e0!3m2!1sen!2sid!4v1651742235596!5m2!1sen!2sid"
                    width="1000"
                    height="500"
                    style="border: 0"
                    allowfullscreen=""
            ...
            <div class="container pb-5 d-flex justify-content-center">
                <p class="text-center">
                    ...
                    Jl. Outstanding Prime Blok F-17 No.117. Kemayoran Jakarta Pusat, Indonesia, <i class="bi bi-telephone"></i> ph: (021) 46667111; Fax. (+62) 46667001 <br />
