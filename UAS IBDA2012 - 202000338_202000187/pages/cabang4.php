...
<html lang="en">
    <head>
        ...
        <title>GABI - Solo | Indonesia</title>
    </head>
    <body>
        <!-- header navbar -->
        ...
        <div class="container pt-5 pb-2 text-center">
            <h1><b>GABI | Solo - Indonesia</b></h1>
        </div>
        <div class="container pb-5 d-flex justify-content-center">
            <div class="card mb-3" style="width: 70%">
                <div class="container pt-2">
                    <img src="../img/galeri_4.jpg" class="card-img-top" alt="gambarrr 1" style="border-radius: 5px" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Gereja Amat Baik Indonesia - Solo | Indonesia</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <p class="card-text"><small class="text-muted">Ruang Remaja</small></p>
                </div>
            </div>
        </div>
        ...
        <div class="container pb-5">
            ...
            $query = "SELECT * FROM jemaat WHERE cabang = 'd' order by tahun";
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="container py-4 d-flex justify-content-center">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d94814.20338711476!2d110.79038816996453!3d-7.560914671047257!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a16855db09efb%3A0xa6c2dbfdf275a4f9!2sSurakarta%20City%2C%20Central%20Java!5e0!3m2!1sen!2sid!4v1651743076570!5m2!1sen!2sid"
                    width="1000"
                    height="500"
                    style="border: 0"
                    allowfullscreen=""
            ...
            <div class="container pb-5 d-flex justify-content-center">
                <p class="text-center">
                    ...
                    Jl. Baik Sentosa No.224. Solo, Indonesia, <i class="bi bi-telephone"></i> ph: (035) 48887112; Fax. (+62) 11667001 <br />
