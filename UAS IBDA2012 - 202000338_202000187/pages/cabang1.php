...
<html lang="en">
    <head>
        ...
        <title>GABI - Sydney | Australia</title>
    </head>
    <body>
        <!-- header navbar -->
        ...
        <div class="container pt-5 pb-2 text-center">
            <h1><b>GABI | Sydney - Australia</b></h1>
        </div>
        <div class="container pb-5 d-flex justify-content-center">
            <div class="card mb-3" style="width: 70%">
                <div class="container pt-2">
                    <img src="../img/galeri_1.jpg" class="card-img-top" alt="gambarrr 1" style="border-radius: 5px" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Gereja Amat Baik Indonesia - Sydney | Australia</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <p class="card-text"><small class="text-muted">Aula Oyster</small></p>
                </div>
            </div>
        </div>
        ...
        <div class="container pb-5">
            ...
            $query = "SELECT * FROM jemaat WHERE cabang = 'a' order by tahun";
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="container py-4 d-flex justify-content-center">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13378294.320981542!2d128.10373837554224!3d-23.236945281812957!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2b2bfd076787c5df%3A0x538267a1955b1352!2sAustralia!5e0!3m2!1sen!2sid!4v1651740832616!5m2!1sen!2sid"
                    width="1000"
                    height="500"
                    style="border: 0"
                    allowfullscreen=""
            ...
            <div class="container pb-5 d-flex justify-content-center">
                <p class="text-center">
                    ...
                    Kangaroo B St. Blok G-171 No.17. Sydney, Australia, <i class="bi bi-telephone"></i> ph: (96) 56667222; Fax. (+96) 56667004 <br />
